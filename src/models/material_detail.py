...
class MaterialDetail(db.Model):
    ...
    # Relaciones
    materials = db.relationship('Material', back_populates='material_detail', lazy=True)
    provider = db.relationship('Provider', back_populates='material_details', lazy=True)
